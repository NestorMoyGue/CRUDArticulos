...
import { darDeBaja, get, getAll, getByEstado, insert, update , getByNombre} from '../controllers/articulo.controller';
...
router.get('/nombre/:nombre', autenticarJWT, catchAsyncErrors(getByNombre));
